...
const UpdateAddedFood = () => {
    ...
    const {_id, image, category,food_name, date, food_origin ,made_by,quantity, price, description} = updateAddedFood;
    ...
    const handleUpdateAddedFood = e => {
        ...
        const updatedAddedFood = {category,image, food_name, price, date, made_by,food_origin, quantity, description, email, name}
        console.log(updatedAddedFood);
        axiosHook.put(`/allFoods/${_id}`,updatedAddedFood)
    ...
    return (
        <div className=" bg-base-200">
            <h1 className=" font-bold text-4xl text-center mb-2">Update Your Added Food: <span className="text-[#FF3811]">{food_name}</span></h1>
