...
const Staffs = () => {
    ...
    <div className='my-2'>
        ...
        <p className='text-sm  dark:text-gray-200 text-center my-3 hidden md:block lg:block'>Skilled chef crafting exquisite dishes, blending flavors for a delightful.Delicious cuisine, prompt service,<br />
