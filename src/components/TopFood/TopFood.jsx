...
//         const res = await hookAxios.get("/topFoods");
//         return res;
//     };

//     const { data: topFoods, isLoading, isError, error } = useQuery({
//         queryKey: ["topFoods"],
//         queryFn: getTopFoods,
//     });
...
//         <div className="my-6">
//             <h2 className="font-bold text-4xl text-center">Our Top Foods Zone</h2>
//             <p className="text-[#FF3811] mt-2 text-center">
//                 You will get our most ordered food in this zone.
//             </p>
//             <p className="text-sm dark:text-gray-200 text-center my-3">
//                 Skilled chef crafting exquisite dishes, blending flavors for a delightful. Delicious
//                 cuisine, prompt service, <br />
//                 inviting ambiance our commitment to your dining satisfaction.
//             </p>
//             <div className="grid sm:grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-6">
//                 {topFoods?.data?.map((food, index) => (
